...
public class Ejemplo3 {
    ...
    public static void main(String[] args) {
        ...
        double promedioAsignaturas;
        String nombreEstudiante;
        //Agregar una nueva variable para la asignatura 3
        //Agregar una nueva variable para la nota 3
        ...
        promedioAsignaturas = (notaAsignatura1 + notaAsignatura2 + notaAsignatura3) / 3;
